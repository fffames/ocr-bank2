"""
Optimized vector store with faster model loading and caching
"""
import chromadb
...
class VectorStore:
    """Vector store for semantic search using ChromaDB with optimizations."""
    ...
    def __init__(self):
        ...
        # Lazy loading - model will be loaded only when needed
        self._embedding_model = None
        self._model_lock = threading.Lock()

    def _load_embedding_model(self):
        """Load embedding model in a thread-safe manner with caching."""
    ...
    def _generate_embedding(self, text: str) -> List[float]:
        """Generate embedding for text using sentence-transformers with lazy loading."""
